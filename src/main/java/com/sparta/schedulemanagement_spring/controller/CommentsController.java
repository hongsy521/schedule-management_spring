...
public class CommentsController {
   ...
   /* // 댓글 조회
    ...
    public List<CommentsResponseDto> getAllComments(@PathVariable int scheduleId) {
        return commentsService.getAllComments(scheduleId);
    }
    // 댓글 수정
    @PutMapping("/schedules/{scheduleId}/comments/{commentId}")
    public CommentsResponseDto updateComment(@PathVariable int scheduleId, @PathVariable int commentId, @RequestBody CommentsRequestDto requestDto) {
        return commentsService.updateComment(scheduleId,commentId,requestDto);
    }
    // 댓글 삭제
    @DeleteMapping("/schedules/{scheduleId}/comments/{commentId}")
    public CommentsResponseDto deleteComment(@PathVariable int scheduleId, @PathVariable int commentId) {
